...
# %%
# Define file paths
base_path = 'region_R2/' # Ensure this path is correct relative to the notebook location
h5ad_file = os.path.join(base_path, '202503071102_SESSA-p30-E165_VMSC10702_region_R2.h5ad')
