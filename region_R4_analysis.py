...
# %% [markdown]
# This notebook performs an analysis of MERSCOPE data for region R4, focusing on data loading, exploratory data analysis (EDA), and visualization.
...
# %%
# Define file paths
base_path = 'region_R4/' # Ensure this path is correct relative to the notebook location
...
plt.title("Experiment Summary Image (region_R4/summary.png)")
plt.show()
